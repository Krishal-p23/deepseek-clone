...
const PromptBox = ({ isLoading, setIsLoading }) => {
    ...
    const sendPrompt = async (e) => {
        ...
        try {
            ...
            if (!prompt.trim()) {
                return toast.error("No prompt found");
            }
    ...
    return (
        <form className={`w-full ${selectedChat?.messages?.length > 0 ? "max-w-3xl" : "max-w-2xl"}
        bg-[#404045] p-4 rounded-3xl mt-4 transition-all`} onSubmit={sendPrompt}>
            <textarea
            ...
            <div className="flex items-center justify-between text-sm">
                ...
                <div className="flex items-center gap-2">
                    <Image className="w-4" src={assets.pin_icon} alt="" />
