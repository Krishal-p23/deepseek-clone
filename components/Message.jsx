                        ...
                        <div className="flex items-center gap-2 opacity-70">
                            {
                                role === 'user' ? (
                                    <>
                                        <Image className="w-4 cursor-pointer"
                                            src={assets.copy_icon} alt="" onClick={copyMessage} />
                                        <Image className="w-4.5 cursor-pointer"
                                            src={assets.pencil_icon} alt="" />
                                    </>
                                ) : (
                                    <>
                                        <Image className="w-4.5 cursor-pointer"
                                            src={assets.copy_icon} alt="" onClick={copyMessage} />
                                        <Image className="w-4 cursor-pointer"
                                            src={assets.regenerate_icon} alt="" />
                                        <Image className="w-4 cursor-pointer"
                                            src={assets.like_icon} alt="" />
                                        <Image className="w-4 cursor-pointer"
                                            src={assets.dislike_icon} alt="" />
                                    </>
                                )
                            }
                        </div>
