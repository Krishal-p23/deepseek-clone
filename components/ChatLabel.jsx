...
const ChatLabel = ({ openMenu, setOpenMenu, id, name, textSize = "text-sm" }) => {
    ...
    return (
        <div className={`flex items-center justify-between gap-3 p-2 text-white/80 hover:bg-white/10 rounded-lg ${textSize} group cursor-pointer`}
            onClick={selectChat}>
            ...
            <div className="group relative flex items-center justify-center h-6 w-6 aspect-square hover:bg-black/80 rounded-lg"
                ...
                <div className={`absolute w-4 ${openMenu.id === id && openMenu.open ? "block" : "hidden"} -right-36 top-6 bg-gray-700 rounded-xl w-max p-2`}>
