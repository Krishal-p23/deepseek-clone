...
const Sidebar = ({ expand, setExpand }) => {
    ...
    const [openMenu, setOpenMenu] = useState({ id: 0, open: false, position: null });

    return (
        <div className={`flex flex-col bg-[#212327] pt-7 transition-all z-50 max-md:absolute max-md:h-screen ${expand ? "w-64" : "md:w-20 w-0 max-md:overflow-hidden"} h-screen min-h-0`}>
            <div className="flex flex-col flex-1 min-h-0 pt-4">
                ...
                <div className={`mt-8 text-white/25 text-sm flex-1 min-h-0 overflow-y-auto overflow-x-hidden ${expand ? "block" : "hidden"} custom-scrollbar`}>
                    <div className="px-4 text-white/25 text-sm">
            ...
            <div className="shrink-0 mt-auto px-4 pb-4">
                <div>
