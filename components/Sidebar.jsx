            ...
            <div>
                ...
                <button className={`mt-8 flex items-center justify-center cursor-pointer 
                    ...
                    <Image className={expand ? "w-6" : "w-7"}
                        ...
                        alt="" />
                    <div className="absolute w-max -top-12 -right-12 opacity-0
                    group-hover:opacity-100 transition bg-black text-white text-sm px-3 py-2
                ...
                <div className={`flex item-center cursor-pointer group relative ${expand ?
                    ...
                    opacity-0 group-hover:opacity-100 hidden group-hover:block transition`}>
                        <div className="relative w-max bg-black text-white text-sm p-3 rounded-lg shadow-lg">
                            ...
                            <div classNme={`w-3 h-3 absolute bg-black rotate-45 
